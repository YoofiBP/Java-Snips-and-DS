...
public class JukeBox {
    public static void main(String[] args) {
        ...
        List<Song> rockOnlySongs = songs.stream().filter(song -> song.getGenre().toLowerCase().contains("rock"))
                .collect(Collectors.toList());
        System.out.println(rockOnlySongs);
        List<String> allGenres = songs.stream().map(Song::getGenre).distinct().collect(Collectors.toList());
